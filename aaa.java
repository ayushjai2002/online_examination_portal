	...
	// {
	 ...
	 // { 
		 ...
		 // if(registration.rb3.isSelected())
		 // {
			 // s3=registration.rb1.getLabel();
		 // }
	     ...
	     // String s11=registration.c2.getSelectedItem();//2
        ...
        // st.executeUpdate(s);
			...
			// JOptionPane.showMessageDialog(registration.b1,"Data Insert Successfuly","My Title",JOptionPane.INFORMATION_MESSAGE);
